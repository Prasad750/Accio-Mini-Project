...
# Features
Finds the shortest path between a starting and ending point in a 2D grid maze. Supports rectangular mazes of any size. Handles mazes with walls that block the path. Outputs the optimal path as a sequence of coordinates
